...
const MyOT = () => {
  ...
  const fetchRejectedReasons = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/user/getRejectOTT/${userId}`, {
        method: 'GET',
        headers: {
  ...
  const fetchOTRequests = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/user/getMyOTRequests`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const deleteOTRequest = async (otId) => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/v1/user/deleteOT/${otId}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
